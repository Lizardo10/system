...
class Sales extends Secure_area
{
  ...
  function cancel_sale()
  {
	...
	/*Función que solicita la certificación de la SAT*/
	
	function fel($sale_id)
	{
		$receipt_cart = PHPPOSCartSale::get_instance_from_sale_id($sale_id);
		if ($this->config->item('sort_receipt_column'))
		{
		...
		$this->load->view("sales/fel_receipt",$data);
	}
	
	/*Esta función decodifica la factura enviada por la sat y la muestra en HTML*/
