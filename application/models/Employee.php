	...
	*/
	...
	function get_displayable_columns()
	{
		$columns = array(
			...
			'commission_percent_type' => 				array('sort_column' => 'commission_percent_type','label' => lang('common_commission_default_rate'),'format_function' => 'commission_percent_type_formater'),
