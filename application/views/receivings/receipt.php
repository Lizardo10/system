		...
		<div class="col-md-6">
			<span class="hidden-print search no-left-border">
				<ul class="list-inline print-buttons">
					...
					<li>
						<button class="btn btn-primary btn-lg hidden-print" id="barcode_sheet_button" onClick="window.open('<?php echo site_url('reports/export_recv/'.$receiving_id_raw); ?>','_blank');" > <?php echo lang('common_excel_export'); ?> </button>						
					</li>
					<li>
				...
				<div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12">
						<ul class="list-unstyled invoice-address">
							...
							<li id="sale_receipt"><?php echo H($is_po ? lang('receivings_purchase_order') : $receipt_title); ?></li>
			        ...
			        <div class="col-md-4 col-sm-4 col-xs-12">
			            <ul class="list-unstyled invoice-detail">
										<?php if (!isset($transfer_to_location)) {?>
											<li id="sale_id"><span><?php echo $is_po ? lang('receivings_purchase_order') : lang('receivings_id').": "; ?></span><?php echo $is_po ? H($receiving_id_raw) : H($receiving_id); ?></li>
											<?php } else { 
												?>
											<li id="sale_id"><span><?php echo lang('receivings_transfer_id').": "; ?></span><?php echo H($receiving_id_raw); ?></li>
											<?php
											} ?>
							<li id="employee"><span><?php echo lang('common_employee').": "; ?></span><?php echo H($employee); ?></li>
			            </ul>
			        </div>
				        ...
				        <div class="row">
							<?php if ($number_of_items_sold) { ?>
					            <div class="col-md-offset-4 col-sm-offset-4 col-md-6 col-sm-6 col-xs-8">
					                <div class="invoice-footer-heading"><?php echo lang('common_items_purchased'); ?></div>
					            </div>
					            <div class="col-md-2 col-sm-2 col-xs-4">
