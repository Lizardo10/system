					...
					<div class="col-md-6">
						...
						<div class="col-md-12 form">
							...
							<ul class="list-group close-amount">
							  ...
							  <li class="list-group-item"><?php echo lang($payment_type_track).' '.lang('common_total_additions'); ?> [<?php echo anchor('sales/register_add_subtract/add/'.$payment_type_track.'/closeregister', lang('common_edit')); ?>]:  <span class="pull-right"><?php echo to_currency($total_payment_additions[$payment_type_track]); ?> </span></li>
							  <li class="list-group-item"><?php echo lang($payment_type_track).' '.lang('common_total_subtractions'); ?> [<?php echo anchor('sales/register_add_subtract/subtract/'.$payment_type_track.'/closeregister', lang('common_edit')); ?>]:  <span class="pull-right"><?php echo to_currency($total_payment_subtractions[$payment_type_track]); ?> </span></li>
