		...
		<div class="col-md-6">
			<div class="hidden-print search no-left-border">
				<ul class="list-inline print-buttons">
					...
					<li>
						<button class="btn btn-primary btn-lg hidden-print" id="fel_button" onclick="window.open('<?php echo site_url("sales/fel/$sale_id_raw"); ?>', 'blank');"> <?php echo 'CERTIFICAR'; ?></button>
					</li>
