			...
			<table id="register"  class="table table-hover ">
				...
				<tbody id="cart_contents">
					...
					foreach(array_reverse($cart_items, true) as $line=>$item)	
					{
						...
						<tr id="reg_item_top" >
							<td class="text text-center text-success"><a tabindex = "-1" href="<?php echo isset($item->item_id) ? site_url("items/view/".$item->item_id."?redirect=sales") : site_url('home/view_item_kit_modal/'.$item->item_kit_id."?redirect=sales") ; ?>" data-toggle="modal" data-target="#myModal" ><?php echo H($item->name); ?></a></td>
							<td class="text-center">
								<?php
